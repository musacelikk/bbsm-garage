                ...
                <div className="dark-card-bg neumorphic-card rounded-xl p-6 sm:p-8">
                  ...
                  <form onSubmit={handleFormSubmit} className="space-y-4">
                    ...
                    <button
                      ...
                      className={`w-full bg-gradient-to-r from-blue-600 to-slate-800 font-bold py-3 px-6 rounded-lg neumorphic-inset hover:from-blue-700 hover:to-slate-900 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed ${activeTheme === 'modern' ? 'text-gray-900' : 'text-white'}`}
                    >
                  ...
                  <div className="dark-card-bg neumorphic-card rounded-xl p-6 sm:p-8">
                    ...
                    <div className="flex flex-wrap gap-4">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className={`flex items-center gap-2 px-4 py-2 bg-[#25D366] rounded-lg hover:bg-[#20BA5A] transition-colors neumorphic-inset ${activeTheme === 'modern' ? 'text-gray-900' : 'text-white'}`}
                      >
