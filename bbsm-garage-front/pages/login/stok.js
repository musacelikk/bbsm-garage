        ...
        <div className="flex-1 flex flex-col">
          ...
          <ProtectedPage>
            ...
            <div className="hidden md:block">
                ...
                <form onSubmit={handleSubmit} className="p-2">
                  <div className="grid gap-6 mb-4 md:grid-cols-3">
                    ...
                    <div>
                        ...
                        <input type="number" id="text" className="bg-my-beyaz border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Adet Giriniz" value={adet}  onChange={(e) => handleChange(e, setAdet)} required/>
                    </div>
                    <div>
              ...
              <div className="p-6 bg-my-beyaz rounded-3xl mt-6">
